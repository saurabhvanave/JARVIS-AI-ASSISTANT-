...
def AuthenticateFace():
    ...
    cascadePath = "engine\\auth\\samples\\trainer\\haarcascade_frontalface_default.xml"
    ...
    names = ['', 'Saurabh','Sanchet','Vedant']  # names, leave first empty bcz counter starts from 0 (1 mi,2 sanchet,3 vedant)
